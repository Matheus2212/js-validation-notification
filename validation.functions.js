...
>>>>>>> refs/remotes/origin/main
    ...
    init: function (object) {
      this.createBox();
      object.title =
        typeof object.title == "undefined" ? "Warning" : object.title;
      object.messages =
        typeof object.messages == "undefined"
          ? "Please check the form"
          : object.messages;
      object.buttons =
        typeof object.buttons == "undefined" ? { ok: "OK" } : object.buttons;
      object.actions =
      ...
      if (
        typeof object.form !== "undefined" &&
        typeof object.callback !== "undefined"
      ) {
...
const Validation = {
  ...
  securityKey: function (elmId, renew) {
    ...
    if (typeof element !== "undefined") {
      ...
      for (var i = 0; i < key.length; i++) {
        ...
        span.style.left = 23.333 * i + 10 + "px";
      ...
      element.parentNode.style.width = "155px";
  ...
  validate: function (evt) {
    ...
    for (var iterate = 0; iterate < elements.length; iterate++) {
      ...
      if (
        ...
        if (!Validation["validate" + requiredType](element)) {
          var message = Validation.getRequiredMessage(element, requiredType);
    ...
    if (messages.length > 0) {
      ...
      if (
        ...
        this.getAttribute("data-title") !== null
      ) {
        var title = this.getAttribute("data-title");
        obj.title = Validation.toHTMLFormat(
          title !== null
            ? title
            : typeof this.parameters.title !== "undefined"
  ...
  bindKeyDown: function (form) {
    ...
    for (var i = 0; i < inputs.length; i++) {
      var input = inputs[i],
        type = this.getRequiredType(input);
  ...
  toggle: function (element, off) {
    ...
    if (forms.length > 0) {
      for (var iterate = 0; iterate < forms.length; iterate++) {
        ...
        off
          ? form.removeEventListener("submit", this.validate, false)
